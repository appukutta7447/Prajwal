...
<head>
    ...
    <title>Alvas | Manage Branch</title>
</head>
<body>
    <section id="main-UI">
                ...
                <div class="container">
                    <div class="wrapper">
                        ...
                        <div class="strand-chooser">
                            ...
                            <div class="topper">
                                <h1> <i class="fas fa-layer-group"></i> Choose Branch</h1>
                                <?php
                                if (!isset($_POST['create-strand-prompt'])) {
                                    ?>
                                    <form method="post">
                                        <button name="create-strand-prompt"> <i class="fas fa-plus"></i> Create Branch</button>
                                    </form>
                                    <?php
                                } else {
                                    ?>
                            ...
                            <div class="strand-chooser-wrapper">
                                ...
                                if (isset($_POST['create-strand-prompt'])) {
                                    ...
                                    <form id="strand-creator-form" method="post">
                                        <input type="text" name="strand-name" placeholder="Branch Name">
                                        
                                        <button name="create-strand-final"> <i class="fas fa-check"></i> Create Branch </button>
                                    </form>
                                    <?php
                                }
                                ...
                                <div class="strand-info-bar">
                                    ...
                                    <div class="strand-controls">
                                        ...
                                        if (isset($_SESSION['strand'])) {
                                            ?>
                                            <form method="post">
                                                <button type="submit" name="edit-strand"> <i class="fas fa-edit"></i> Edit Branch</button>
