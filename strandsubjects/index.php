                ...
                if (isset($_POST['edit-subject']) && decryptData($_POST['subject-id']) == $row['subject_id']) {
                    ...
                    <td> 
                        ...
                        <select name="edit-subject-semester">
                            ...
                            <option value="<?php echo encryptData(3); ?>" <?php if ($row['semester'] == 3) { echo 'selected'; } ?>>3nd Semester</option>
                            <option value="<?php echo encryptData(4); ?>" <?php if ($row['semester'] == 4) { echo 'selected'; } ?>>4nd Semester</option>
                            <option value="<?php echo encryptData(5); ?>" <?php if ($row['semester'] == 5) { echo 'selected'; } ?>>5nd Semester</option>
                            <option value="<?php echo encryptData(6); ?>" <?php if ($row['semester'] == 6) { echo 'selected'; } ?>>6nd Semester</option>
                            <option value="<?php echo encryptData(7); ?>" <?php if ($row['semester'] == 7) { echo 'selected'; } ?>>7nd Semester</option>
                            <option value="<?php echo encryptData(8); ?>" <?php if ($row['semester'] == 8) { echo 'selected'; } ?>>8nd Semester</option>
                        </select>
...
<head>
    ...
    <title>AUSMS | Manage Strand</title>
</head>
<body>
    <section id="main-UI">
