            ...
            <section id="modal">
                <div class="container-fluid">
                    <div class="wrapper">
                        ...
                        <form method="post">
                            <p> <i class="fas fa-info-circle"></i> This lists the all of the available subject in your branch. If there are no options, you have already graded this student to all available subjects.</p>
                        ...
                        <form method="post">
                            <div class="inputs-container">
                                ...
                                <select name="create-subject-semester">
                                    ...
                                    <option value=" <?php echo encryptData(3); ?> ">Third Semester</option>
                                    <option value=" <?php echo encryptData(4); ?> ">Fourth Semester</option>
                                    <option value=" <?php echo encryptData(5); ?> ">Fifth Semester</option>
                                    <option value=" <?php echo encryptData(6); ?> ">Sixth Semester</option>
                                    <option value=" <?php echo encryptData(7); ?> ">Seventh Semester</option>
                                    <option value=" <?php echo encryptData(8); ?> ">Eigth Semester</option>
