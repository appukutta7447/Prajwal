...
function fetchThirdSemesterGrade() {
    $con = connect();
...
function fetchFourthSemesterGrade() {
    $con = connect();
...
function fetchFifthSemesterGrade() {
    $con = connect();
...
function fetchSixthSemesterGrade() {
    $con = connect();
...
function fetchSeventhSemesterGrade() {
    $con = connect();
...
function fetchEigthSemesterGrade() {
    $con = connect();
                            ...
                            <div class="wrapper">
                                ...
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <th class="small-data">CIE</th>
                                        <th class="small-data">SEE</th>
                                ...
                                <table>
                                    <tr>
                                        <th class="sem-title" colspan="5"> <i class="fas fa-flag"></i> Third Semester</th>
                                    </tr>
                                    <tr>
                                        <th class="subject-name">Subject Name</th>
                                        <th class="small-data">CIE</th>
                                    ...
                                    <?php fetchThirdSemesterGrade(); ?>
                                </table>
                                <table>
                                    <tr>
                                        <th class="sem-title" colspan="5"> <i class="fas fa-flag"></i> Fourth Semester</th>
                                    </tr>
                                    <tr>
                                        <th class="subject-name">Subject Name</th>
                                        <th class="small-data">CIE</th>
                                    ...
                                    <?php fetchFourthSemesterGrade(); ?>
                                </table>
                                <table>
                                    <tr>
                                        <th class="sem-title" colspan="5"> <i class="fas fa-flag"></i> Sixth Semester</th>
                                    </tr>
                                    <tr>
                                        <th class="subject-name">Subject Name</th>
                                        <th class="small-data">CIE</th>
                                    ...
                                    <?php fetchSixthSemesterGrade(); ?>
                                </table>
                                <table>
                                    <tr>
                                        <th class="sem-title" colspan="5"> <i class="fas fa-flag"></i> Fifth Semester</th>
                                    </tr>
                                    <tr>
                                        <th class="subject-name">Subject Name</th>
                                        <th class="small-data">CIE</th>
                                    ...
                                    <?php fetchFifthSemesterGrade(); ?>
                                </table>
                                <table>
                                    <tr>
                                        <th class="sem-title" colspan="5"> <i class="fas fa-flag"></i> Seventh Semester</th>
                                    </tr>
                                    <tr>
                                        <th class="subject-name">Subject Name</th>
                                        <th class="small-data">CIE</th>
                                    ...
                                    <?php fetchSeventhSemesterGrade(); ?>
                                </table>
                                <table>
                                    <tr>
                                        <th class="sem-title" colspan="5"> <i class="fas fa-flag"></i> Eigth Semester</th>
                                    </tr>
                                    <tr>
                                        <th class="subject-name">Subject Name</th>
                                        <th class="small-data">CIE</th>
